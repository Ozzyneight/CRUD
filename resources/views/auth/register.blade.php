                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="inputDateOfBirthday"
                                       class="col-md-4 col-form-label text-md-end">{{ __('Дата рождениия') }}</label>

                                <div class="col-md-6">
                                    <input id="inputDateOfBirthday" type="date"
                                           class="form-control @error('date_of_birthday') is-invalid @enderror"
                                           name="date_of_birthday" value="{{ old('date_of_birthday') }}"
                                           autocomplete="date_of_birthday" autofocus>
                            ...
                            <div class="row mb-3">
                                <label for="image"
                                       class="col-md-4 col-form-label text-md-end">{{ __('Аватар') }}</label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="role" type="text" name="role" value="0" hidden>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
